...
) -> Optional[Union[Any, ProblemDetails, SupplierResponseDto]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ProblemDetails, SupplierResponseDto]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ProblemDetails, SupplierResponseDto]
    """
